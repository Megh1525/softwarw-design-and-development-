...
class Manager:
    def __init__(self):
        ...
        self.label_trip.place(x=850,y=150)
        self.entry_trip = tk.Entry(self.root,textvariable = self.e15, font=('calibre',10,'normal'))
        self.entry_trip.place(x=1050,y=150)

        self.btn5=tk.Button(self.root, text='Delete Trips coordinator',width=30,bg='Green',fg='Black',command = self.del_trip_co).place(x=300,y=150)
        self.btn6=tk.Button(self.root, text='Delete Trips',width=30,bg='Yellow',fg='Black',command = self.del_trips).place(x=500,y=150)        
    ...
    def submit(self):
        ...
        with open('tripmanager.csv', 'a') as f_object:
    ...
    def Generate_invoice(self):
        ...
        with open('ManagerInvoice.csv', 'a') as f_object:
